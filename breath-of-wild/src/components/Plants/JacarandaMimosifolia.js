...
export default class JacarandaMimosifolia extends Component {
  
  render() {
    const { Meta } = Card;
    const { Text } = Typography;
    let icon = require("../../../../breath-of-wild/src/assets/images/plantIcon/Jacaranda_mimosifolia.PNG");
    let background = require("../../../../breath-of-wild/src/assets/images/plantImage/EucalyptusTereticornis.PNG");
    ...
    return (
      <Card
          ...
          footer={
              <Space>
                  <Button theme='solid' type='primary'>back</Button>
              </Space>
          }
