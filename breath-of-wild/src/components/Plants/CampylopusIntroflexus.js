...
export default class CampylopusIntroflexus extends Component {
  ...
  render() {
    ...
    let icon = require("../../../../breath-of-wild/src/assets/images/plantIcon/CampylopusIntroflexus.png");
    let background = require("../../../../breath-of-wild/src/assets/images/plantImage/MayacaFluviatilis.PNG");
